...
export default {
	...
	data() {
		return {
			/*排序参数*/
			SortData: [
				{ name: '文件名', value: 'alpha', key: 'disk_name', type: 'up', width: '48%' },
				{ name: '修改日期', value: 'numeric', key: 'create_time', type: 'up', width: '28%' },
				{ name: '大小', value: 'numeric', key: 'disk_size', type: 'up', width: '24%' }
			]
		};
	},
	methods: {
