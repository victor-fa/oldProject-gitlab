<template>
  <div>
    <a-modal
      width="260px" style="top: 120px;" :mask="false" :maskClosable="false"
      okText="确定" cancelText="取消" @ok="handleChoice" @cancel="cancle" :visible="visiable">
      您希望做什么？
      <br><br>
      ...
      <br><br>
      <a-checkbox v-model="rememberChoice">是否记住选择？</a-checkbox>
    </a-modal>
  </div>
</template>
