...
const clearTrashItem: ResourceFuncItem = { icon: require('../../assets/trash_normal_icon.png'), command: 'clearTrash', iconWidth: '16px', title: '清空回收站', disableIcon: require('../../assets/trash_disable_icon.png') }
